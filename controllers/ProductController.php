...
class ProductControllerCore extends FrontController
{
	...
	public function setMedia()
	{
		...
		Tools::addCSS(_PS_JS_DIR_.'jquery/fancybox2/jquery.fancybox.css', 'screen');
		Tools::addJS(array(
			//_PS_JS_DIR_.'jquery/jquery.fancybox-1.3.4.js',
			_PS_JS_DIR_.'jquery/fancybox2/jquery.fancybox.js',
		...
		else
		{
			...
			else
			{
				...
				if(!$this->product->customizable)
					Tools::enableCache();
				if(!self::$smarty->isCached(_PS_THEME_DIR_.'product.tpl', $this->smartyCacheId))
				{
	...
	public function displayContent()
	{
		...
		self::$smarty->display(_PS_THEME_DIR_.'product.tpl', $this->smartyCacheId);
