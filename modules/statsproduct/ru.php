...
$_MODULE['<{statsproduct}prestashop>statsproduct_1d0ba341c7847cbff109276485417a1c'] = 'После выбора категории и отбора товара, появятся информационные графы. Тогда, Вы будете в состоянии проанализировать их.';
$_MODULE['<{statsproduct}prestashop>statsproduct_6559cc601f073740b825a4fc9b76149b'] = 'Если Вы замечаете, что товар успешен и часто покупаемый, но просматривается нечасто, Вы должны поместить его более заметно в Ваше фронт-офисе.';
$_MODULE['<{statsproduct}prestashop>statsproduct_20b9641efab51dee7d27eed2b6773ef0'] = 'С другой стороны если товар часто просматривают но редко покупают, мы рекомендуем проверить описание товара и его фото. ';
