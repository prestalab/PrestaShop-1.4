...
class FrontController extends FrontControllerCore
{
	...
	public function run()
	{
		...
		$this->preProcess();
			$this->_memory['preProcess'] = memory_get_usage();
			$this->_time['preProcess'] = microtime(true);
		$this->displayHeader();
			$this->_memory['displayHeader'] = memory_get_usage();
			$this->_time['displayHeader'] = microtime(true);

		$this->process();
			$this->_memory['process'] = memory_get_usage();
			$this->_time['process'] = microtime(true);
		$this->displayContent();

			$this->_memory['displayContent'] = memory_get_usage();
			$this->_time['displayContent'] = microtime(true);
		$this->displayFooter();

			$this->_memory['displayFooter'] = memory_get_usage();
			$this->_time['displayFooter'] = microtime(true);
	...
	public function displayDebug()
	{
		...
		$hookMemoryUsage = Module::getHookMemoryUsage();
